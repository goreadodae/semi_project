...
<!-- 오늘의 레시피 -->
  ...
  <div class="col-md-4" id="todayRecipe">
  	...
  	<div id="rankingLine">
  		<!-- 오늘의 레시피 텍스트 url -->
  		<a id="rankingURL" href="#"><h3 id="rankingTitle">Today's Recipes</h3></a> 
  		<!-- <h5 style="margin:0;">오늘의 레시피</h5> -->
  		<br><br>
			<div class="media-image">
				<a href="#">
						<img class="media-object" src="/imgs/ranking_img/recipe.jpg" alt="오늘의 레시피" style="width: 100%; height: 100%">
				</a>
			</div>
			<br><h5 style="margin:0;">오늘의 레시피</h5>
  	</div>
  </div>
  ...
  <div class="col-md-4" id="monthRecipe"> 
  	...
  	<div id="rankingLine">
  		<!-- 이달의 레시피 텍스트 url -->
  		<a id="rankingURL" href="#"><h3 id="rankingTitle">Monthly Recipes</h3></a> 
  		<!-- <h5 style="margin:0;">이달의 레시피</h5> -->
  		<br><br>
			<div class="media-image">
				<a href="#">
						<img class="media-object" src="/imgs/ranking_img/ingredient.jpg" alt="이달의 레시피" style="width: 100%; height: 100%">
				</a>
			</div>  
			<br><h5 style="margin:0;">이달의 레시피</h5>		
  	</div>
  </div>
  ...
  <div class="col-md-4" id="monthUserRecipe">
  	...
  	<div id="rankingLine">
  		...
  		<br><br>
			<div class="media-image">
				<a href="#">
						<img class="media-object" src="/imgs/ranking_img/chef-1245676_1920.jpg" alt="이달의 회원" style="width: 100%; height: 100%">
				</a>
			</div> 
			<br><h5 style="margin:0;">이달의 회원</h5>  		
  	</div>
</div>
...
<div class="container">
	<div class="row">
		...
		<a href=""><label>오늘의 레시피</label></a>     <a href=""><label>이달의 레시피</label></a>     <a href=""><label>이달의 회원</label></a>     
		</pre>
	</div>
</div>
