...
<body>
	...
	<div id="footer_cc" class="com-md-4">
		...
		<div class="row">
			<!-- 전화문의 -->
			<div class="col-md-4 cc-call-view" id="call_cc" style="padding-left: 15px;">
				<h6>
					<span>전화문의(010-4844-5132)</span>
				</h6>
				<dl class="list" style="margin-bottom: 0px;">
					<dt style="float: left; font: bold; padding-right: 8px; margin-bottom: 0px;">평일</dt>
					<dd style="margin-bottom: 0px;">오전 8시 - 오후 4시 
						<span style="font-size: 13px;">(점심시간 오후12시-오후1시)</span>
					</dd>
				</dl>
				<dl class="list">
			...
			<div class="col-md-4 cc-qna-view" style="padding-left: 15px;">
				...
				<p>궁금한 점이 있으신가요? <br> 1:1 문의에 남겨주시면 친절히 답변 드리겠습니다.</p>
			</div>
			<!-- 1:1 문의 끝  -->
		</div>
	</div>
	...
	<div id="footer_link" class="col-md-12" style="padding: 0px;">
		<ul style="padding: 0px;">
			<li style="padding-left: 0px; font-size: 15px;"><a href="#">수상한 레시피 소개</a></li>
	...
	<div id="footer_info" class="col-md-12" style="padding: 0px;">
		<div class="row">
			...
			<!-- 회사정보 2 -->
			<div id="info_company2" class="col-md-4" style="padding-left: 15px;">
				<dl style="font-size: 12px; margin-bottom: 0px;">
