					...
					<div class="row">
						<div class="col-md-7 mx-auto">
							<div class="row">
								...
								<div class="col-md-3">
									<form action="/noticeUpdateReady" style="display: inline;">
										<input type="hidden" name="noticeNo"
											value="${requestScope.notice.noticeNo}">
								...
								<div class="col-md-3">
									<button type="button"
										onclick="location.href='/views/customerCenterPage/noticeWrite.jsp'"
					...
					<table class="table "
						...
						<tr>
							<c:if test="${!empty requestScope.nexNotice}">
								...
								<td><a
									href="/noticeDetail?noticeNo=${requestScope.notice.noticeNo+1}">${requestScope.nexNotice}</a></td>
							</c:if>
							<c:if test="${empty requestScope.nexNotice}">
								<td colspan="2">
									<!--공백이 숨어있어요  -->
						...
						<tr>
							<c:if test="${!empty requestScope.preNotice}">
								<td
									style="width: 5%; border-right: 1px solid #dcdcdc; !important">이전글</td>
								<td colspan="2"><a
									href="/noticeDetail?noticeNo=${requestScope.notice.noticeNo-1}">${requestScope.preNotice}</a></td>
							</c:if>
							<c:if test="${empty requestScope.preNotice}">
								<td colspan="2">
									<!--공백이 숨어있어요  -->
