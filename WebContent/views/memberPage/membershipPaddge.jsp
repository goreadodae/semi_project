...
<body style="overflow-x: hidden; overflow-y: auto;">
	...
	<div class="container-fluid"
		style="padding: 0px; border: 10px solid black;">
		<!-- 컨텐츠 영역 -->
		<div id="content-main" class="contents" style="border: 5px solid red;">
			<div class="container" style="padding: 0; border: 5px solid blue;">
				<div class="col-md-12 member-join"
					...
					<div class="button-bar" id="btnBar1">
						<div class="right">
							<button type="button" class="btn btn-primary btn-lg"
								...
								않음</button>
							<button type="button" class="agree2 btn btn-primary btn-lg"
